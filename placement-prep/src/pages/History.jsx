            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-12 pr-6 py-3 bg-white border border-slate-200 rounded-2xl w-full md:w-80 focus:ring-2 focus:ring-primary/20 outline-none transition-all font-medium text-sm"
                    />
                </div>
            </header>

            {history.length === 0 ? (
                <div className="bg-white rounded-[2.5rem] border border-slate-200 p-20 text-center space-y-6">
                    <div className="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mx-auto text-slate-300">
                        <HistoryIcon size={40} />
                    </div>
                    <div>
                        <h2 className="text-2xl font-black text-slate-900 mb-2">No Archives Found</h2>
                        <p className="text-slate-500">Your analysis history will appear here once you process your first JD.</p>
                    </div>
                    <button
                ...
                <div className="grid grid-cols-1 gap-4">
                    {history.map((entry) => (
                        <div
                            ...
                            className="bg-white group border border-slate-100 hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 p-6 md:p-8 rounded-[2rem] transition-all cursor-pointer flex flex-col md:flex-row items-center gap-8"
                        >
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-2">
                                    <h3 className="text-xl font-black text-slate-900 group-hover:text-primary transition-colors">{entry.role || 'Expert Role'}</h3>
